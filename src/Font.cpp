...
void Font::write(std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color)
{
	// Activate corresponding render state
	m_shader->enable();
	glUniform3f(glGetUniformLocation(m_shader->get_id(), "textColor"), color.x, color.y, color.z);
